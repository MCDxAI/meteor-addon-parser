...
public final class MeteorStarscript {
  public static meteordevelopment.starscript.Starscript ss =
      new meteordevelopment.starscript.Starscript();
  ...
  public static meteordevelopment.starscript.value.Value wrap(
      meteordevelopment.meteorclient.utils.misc.HorizontalDirection value) {
    return meteordevelopment.starscript.value.Value.null_();
  }

  public static net.minecraft.class_2960 popIdentifier(
      meteordevelopment.starscript.Starscript starscript, String key) {
    return null;
  }
}
