...
public class BlockListSetting extends Setting<List<net.minecraft.class_2248>> {
    ...
    private BlockListSetting(String name, String description, List<net.minecraft.class_2248> defaultValue,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, List<net.minecraft.class_2248>, BlockListSetting> {
        private java.util.function.Predicate<net.minecraft.class_2248> filter;
        ...
        public BlockListSetting build() {
            return new BlockListSetting(name, description, defaultValue, onChanged, onModuleActivated, visible, filter);
        }
    }
}
