...
public class BlockPosSetting extends Setting<net.minecraft.class_2338> {
    private BlockPosSetting(String name, String description, net.minecraft.class_2338 defaultValue,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, net.minecraft.class_2338, BlockPosSetting> {
        public Builder() {
