...
public class SoundEventListSetting extends Setting<List<net.minecraft.class_3414>> {
    private SoundEventListSetting(String name, String description, List<net.minecraft.class_3414> defaultValue,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, List<net.minecraft.class_3414>, SoundEventListSetting> {
        public Builder() {
            super(new ArrayList<>());
        }

        public Builder defaultValue(net.minecraft.class_3414... values) {
            this.defaultValue = values == null ? new ArrayList<>() : new ArrayList<>(java.util.Arrays.asList(values));
            return this;
        }
