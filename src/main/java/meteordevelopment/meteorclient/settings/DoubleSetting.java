...
public class DoubleSetting extends Setting<Double> {
    ...
    private DoubleSetting(String name, String description, Double defaultValue, Consumer<Double> onChanged,
                          Consumer<Setting<Double>> onModuleActivated, IVisible visible,
                          double min, double max, double sliderMin, double sliderMax, boolean noSlider) {
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, Double, DoubleSetting> {
        ...
        public DoubleSetting build() {
            ...
            return new DoubleSetting(name, description, defaultValue, onChanged, onModuleActivated, visible,
                min, max, actualSliderMin, actualSliderMax, noSlider);
        }
    }
}
