...
public class EntityTypeListSetting extends Setting<Set<net.minecraft.class_1299>> {
    ...
    private EntityTypeListSetting(String name, String description, Set<net.minecraft.class_1299> defaultValue,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, Set<net.minecraft.class_1299>, EntityTypeListSetting> {
        private boolean onlyAttackable;
