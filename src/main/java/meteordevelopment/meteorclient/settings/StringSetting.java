...
public class StringSetting extends Setting<String> {
    ...
    private StringSetting(String name, String description, String defaultValue, Consumer<String> onChanged,
                          Consumer<Setting<String>> onModuleActivated, IVisible visible,
                          String placeholder, Class<?> renderer, boolean wide,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, String, StringSetting> {
        ...
        public StringSetting build() {
            return new StringSetting(name, description, defaultValue, onChanged, onModuleActivated, visible,
                placeholder, renderer, wide, filter);
        }
    }
}
