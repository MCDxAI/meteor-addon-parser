...
public class ScreenHandlerListSetting extends Setting<List<Object>> {
    private ScreenHandlerListSetting(String name, String description, List<Object> defaultValue,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, List<Object>, ScreenHandlerListSetting> {
        public Builder() {
            super(new ArrayList<>());
        }
