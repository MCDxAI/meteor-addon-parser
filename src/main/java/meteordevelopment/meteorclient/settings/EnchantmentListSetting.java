...
public class EnchantmentListSetting extends Setting<Set<net.minecraft.class_5321>> {
    ...
    public static class Builder extends SettingBuilder<Builder, Set<net.minecraft.class_5321>, EnchantmentListSetting> {
        public Builder() {
        ...
        public Builder defaultValue(net.minecraft.class_1887... enchantments) {
            ...
            if (enchantments != null) {
                for (net.minecraft.class_1887 ignored : enchantments) {
                    keys.add((net.minecraft.class_5321) StubSupport.defaultValue(net.minecraft.class_5321.class));
                }
            }
