...
public class Vector3dSetting extends Setting<org.joml.Vector3d> {
    private Vector3dSetting(String name, String description, org.joml.Vector3d defaultValue,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, org.joml.Vector3d, Vector3dSetting> {
        public Builder() {
        ...
        public Vector3dSetting build() {
            return new Vector3dSetting(name, description, defaultValue, onChanged, onModuleActivated, visible);
        }
    }
}
