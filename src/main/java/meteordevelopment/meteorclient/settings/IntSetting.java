...
public class IntSetting extends Setting<Integer> {
    ...
    private IntSetting(String name, String description, Integer defaultValue, Consumer<Integer> onChanged,
                       Consumer<Setting<Integer>> onModuleActivated, IVisible visible,
    ...
    public static class Builder extends Setting.SettingBuilder<Builder, Integer, IntSetting> {
        ...
        public IntSetting build() {
            ...
            return new IntSetting(name, description, defaultValue, onChanged, onModuleActivated, visible,
